        ...
        @endforeach<div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0"style="color:blue; ">   Style For {{$u->fullname}} ({{$u->phonenumber}}) </h4>
                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="/measurement/{{$u->clientid}}/{{$clientstyle->id}}/{{$clientstyle->styleid}}" class="btn btn-success">Take Measurement</a></td>
