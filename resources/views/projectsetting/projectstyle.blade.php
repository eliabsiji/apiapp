        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0"style="color:blue; ">  Client Style For {{$project->projectname}} {{$project->deadline}} </h4>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item active">Client style -List</li>
                        </ol>
                        <div class="page-title-right">
                            <a href="{{route('projectmanager')}}" class="btn btn-sm btn-success edit-item-btn"><< Back</a>
                        </div>
                    </div>
